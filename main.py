...
print("Once your to do list or thought garbage bin reaches 1000, the first items you added will be overwritten by new entries.")
exit = False
num = 1
key = 1
while exit == False:
    ...
    if choice == "1":
        ...
        new_choice = input("Type 1 to add a thought. Type 2 to review old thoughts. Not recommended. You left them here for a reason. Type 3 if you'd like to remove a thought.")
        if new_choice == "1":
